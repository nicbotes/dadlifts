...
.bar{display:flex;align-items:center;gap:5px;padding:0 10px;height:52px;background:var(--bg);border-bottom:3px solid var(--ink);position:sticky;top:0;z-index:50;overflow:hidden}
